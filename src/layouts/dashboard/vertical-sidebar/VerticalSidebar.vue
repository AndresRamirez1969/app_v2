...
const hasBusinessUnitViewAny = computed(() =>
  permissions.value.includes("businessUnit.viewAny")
);
...
const hasResponseViewAny = computed(() =>
  permissions.value.includes("form_response.viewAny")
);
const hasBusinessUnitGroupViewAny = computed(() =>
  permissions.value.includes("businessUnitGroup.viewAny")
);
  ...
  >
    ...
    <perfect-scrollbar class="scrollnavbar">
      <v-list aria-busy="true" aria-label="menu list">
        <template
          v-for="(item, i) in sidebarMenu.filter((item) => item !== null)"
          :key="i"
        >
