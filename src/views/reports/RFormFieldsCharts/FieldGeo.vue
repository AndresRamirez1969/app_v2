          ...
          <template v-for="(resp, i) in paginatedResponses" :key="i">
            <tr class="response-row record-row">
              <td class="response-value-cell">
                ...
                <span v-else style="color: #1976d2; text-decoration: underline; font-weight: 500">
                  {{ resp.folio || resp.id || '-' }}
                </span>
              </td>
              <td class="response-value-cell">
              ...
              <td class="response-value-cell">
                <a
                  ...
                  :href="`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(getAddressFromValue(resp.value))}`"
                  target="_blank"
          ...
          <v-col v-for="(resp, i) in paginatedResponses" :key="i" cols="12">
            <v-card class="mb-4 pa-3 elevation-1 rounded-lg response-card" style="cursor: default; position: relative">
              ...
              <div class="d-flex flex-column mb-1" style="gap: 8px">
                ...
                <span v-else style="color: #1976d2; text-decoration: underline; font-weight: 500; min-width: 60px">
                  {{ resp.folio || resp.id || '-' }}
                </span>
